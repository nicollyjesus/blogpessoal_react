			...
			<div className="container mx-auto max-w-7xl">
				<div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
					<div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr]">
						{/* Seção da foto */}
						<div className="bg-linear-to-br from-indigo-600 via-indigo-400 to-indigo-300 p-8 flex flex-col items-center justify-center">
						...
						<div className="p-8 lg:p-12">
							...
							<form onSubmit={atualizarUsuario} className="space-y-6">
								...
								<div className="flex flex-col sm:flex-row gap-4 pt-4">
									<button
										type="button"
										className="flex-1 px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 transition-colors"
										onClick={retornar}
									>
										Cancelar
									</button>
